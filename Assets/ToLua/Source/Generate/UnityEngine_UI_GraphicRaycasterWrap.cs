...
public class UnityEngine_UI_GraphicRaycasterWrap
{
	...
	static int Raycast(IntPtr L)
	{
		try
		{
			...
			UnityEngine.UI.GraphicRaycaster obj = (UnityEngine.UI.GraphicRaycaster)ToLua.CheckObject(L, 1, typeof(UnityEngine.UI.GraphicRaycaster));
	...
	static int get_ignoreReversedGraphics(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index ignoreReversedGraphics on a nil value" : e.Message);
		}
	}
	...
	static int get_blockingObjects(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index blockingObjects on a nil value" : e.Message);
		}
	}

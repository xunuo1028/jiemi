...
public class UnityEngine_UI_HorizontalOrVerticalLayoutGroupWrap
{
	...
	static int get_childControlWidth(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index childControlWidth on a nil value" : e.Message);
		}
	}
	...
	static int get_childControlHeight(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index childControlHeight on a nil value" : e.Message);
		}
	}

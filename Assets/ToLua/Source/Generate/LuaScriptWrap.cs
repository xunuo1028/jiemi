...
public class LuaScriptWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(LuaScript), typeof(UnityEngine.MonoBehaviour));
	...
	static int GetType(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(LuaScript)))
			{
				LuaScript obj = (LuaScript)ToLua.ToObject(L, 1);
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(string)))
			{
				...
				System.Type o = LuaScript.GetType(arg0);
				ToLua.Push(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaScript.GetType");
			}
		}
		catch(Exception e)
		{
	...
	static int InvokeDelegate(IntPtr L)
	{
		...
		{
			int count = LuaDLL.lua_gettop(L);
			LuaScript obj = (LuaScript)ToLua.CheckObject(L, 1, typeof(LuaScript));

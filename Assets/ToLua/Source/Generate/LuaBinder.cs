...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaScriptWrap.Register(L);
		LuaScriptExtWrap.Register(L);
		NetServiceWrap.Register(L);
		NetConnectionWrap.Register(L);
		ApplicationControllerWrap.Register(L);
		ResourceControllerWrap.Register(L);
		EventTriggerProxyWrap.Register(L);
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("ResourceController");
		ResourceController_AssetLoaderWrap.Register(L);
		L.EndModule();
		L.BeginModule("EventTriggerProxy");

...
public class ResourceController : MonoBehaviour
{
    ...
    public static string DataPath
    {
        get
        {
            string game = ApplicationConfig.ApplicationName.ToLower();
    ...
    {
        string path = ApplicationConfig.LuaDebugMode ? Application.dataPath + "/" : DataPath;
    ...
    public void InitBundleDependencies()
    {
        ...
        var uri = Application.dataPath + "/StreamingAssets/StreamingAssets";

        Debug.Log("33333333333333333" + File.Exists(uri) + " " + uri) ;
    ...
    private AssetBundle LoadAssetBundle(string abname)
    {
        ...
        if (!bundles.ContainsKey(abname))
        {
            ...
            string uri = Application.dataPath + "/StreamingAssets/" + abname;
    ...
    public UnityEngine.Object LoadAsset(string abname, string assetname, string assettype)
    {
        ...
        return bundle.LoadAsset(assetname, ApplicationController.GetType(assettype));
    }
    ...
    public class AssetLoader
    {
        ...
        private IEnumerator doLoadAsset()
        {
            ...
            {
                var r = bundle.LoadAssetAsync(assetname, ApplicationController.GetType(assettype));
                while (!r.isDone)
                {
                    yield return new WaitForSeconds(0.05f);
                }

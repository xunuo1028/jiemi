...
public class EventTriggerProxy : UnityEngine.EventSystems.EventTrigger
{
    ...
    public static EventTriggerProxy Get(GameObject go)
    {
        EventTriggerProxy proxy = go.GetComponent<EventTriggerProxy>();
        if (proxy == null) proxy = go.AddComponent<EventTriggerProxy>();
        return proxy;
    }
